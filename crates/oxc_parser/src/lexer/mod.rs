...
use oxc_syntax::{
    identifier::{
        ...
        is_identifier_start_all, is_identifier_start_ascii_byte, is_identifier_start_unicode,
        is_irregular_line_terminator, is_irregular_whitespace, is_line_terminator, CR, FF, LF, LS,
        PS, TAB, VT,
    },

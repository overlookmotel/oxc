...
pub const ASCII_START_BYTE: Align64<[bool; 256]> = extend_to_256_len(&ASCII_START);
pub const ASCII_CONTINUE_BYTE: Align64<[bool; 256]> = extend_to_256_len(&ASCII_CONTINUE);
